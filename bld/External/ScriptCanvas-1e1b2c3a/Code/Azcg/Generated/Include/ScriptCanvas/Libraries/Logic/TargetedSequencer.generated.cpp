 ...
 * Template Source /fast_drive/development/Hobby/Games/o3de/Gems/ScriptCanvas/Code/Include/ScriptCanvas/AutoGen/ScriptCanvasGrammar_Source.jinja; Data Sources /fast_drive/development/Hobby/Games/o3de/Gems/ScriptCanvas/Code/Include/ScriptCanvas/Libraries/Logic/TargetedSequencer.ScriptCanvasGrammar.xml
 */
...
#include "Include/ScriptCanvas/Libraries/Logic/TargetedSequencer.h"

void ScriptCanvas::Nodes::Logic::TargetedSequencer::ConfigureSlots()
{
        ...
        // Index
    {
        ...
        slotConfiguration.m_toolTip = "Select which [Out#] to trigger.";
                slotConfiguration.m_displayGroup = "OutputGroup";
    ...
    {
        ScriptCanvas::ExecutionSlotConfiguration slotConfiguration;
        slotConfiguration.m_name = "Out 0";
...
bool ScriptCanvas::Nodes::Logic::TargetedSequencer::RequiresDynamicSlotOrdering() const
{
    return false;
}


bool ScriptCanvas::Nodes::Logic::TargetedSequencer::IsDeprecated() const
{
    return false;
}


void ScriptCanvas::Nodes::Logic::TargetedSequencer::Reflect(AZ::ReflectContext* context)
{
    ...
    {
        serializeContext->Class<ScriptCanvas::Nodes::Logic::TargetedSequencer, ScriptCanvas::Node>()
        ;

        if (AZ::EditContext* editContext = serializeContext->GetEditContext())
        {
            editContext->Class<ScriptCanvas::Nodes::Logic::TargetedSequencer>("Switch", "Triggers the specified output when triggered.")
...
int TargetedSequencerProperty::GetIndex(ScriptCanvas::Node* owner)
{
