 ...
 * Template Source /fast_drive/development/Hobby/Games/o3de/Gems/ScriptCanvas/Code/Include/ScriptCanvas/AutoGen/ScriptCanvasGrammar_Source.jinja; Data Sources /fast_drive/development/Hobby/Games/o3de/Gems/ScriptCanvas/Code/Include/ScriptCanvas/Libraries/UnitTesting/ExpectTrue.ScriptCanvasGrammar.xml
 */
...
#include "Include/ScriptCanvas/Libraries/UnitTesting/ExpectTrue.h"

void ScriptCanvas::Nodes::UnitTesting::ExpectTrue::ConfigureSlots()
{
        ...
        // Candidate
    {
        ...
        slotConfiguration.m_toolTip = "a value that must be true";
...
bool ScriptCanvas::Nodes::UnitTesting::ExpectTrue::RequiresDynamicSlotOrdering() const
{
    return false;
}


bool ScriptCanvas::Nodes::UnitTesting::ExpectTrue::IsDeprecated() const
{
    return true;
}

ScriptCanvas::NodeConfiguration ScriptCanvas::Nodes::UnitTesting::ExpectTrue::GetReplacementNodeConfiguration() const
{
    ScriptCanvas::NodeConfiguration nodeConfig{};
    nodeConfig.m_type = AZ::Uuid("{E42861BD-1956-45AE-8DD7-CCFC1E3E5ACF}");
        nodeConfig.m_methodName = "Expect True";
            nodeConfig.m_className = "Unit Testing";
        return nodeConfig;
}

void ScriptCanvas::Nodes::UnitTesting::ExpectTrue::Reflect(AZ::ReflectContext* context)
{
    ...
    {
        serializeContext->Class<ScriptCanvas::Nodes::UnitTesting::ExpectTrue, ScriptCanvas::Node>()
            ->Version(1, &ScriptCanvas::UnitTesting::ExpectBooleanVersioner)
        ;

        if (AZ::EditContext* editContext = serializeContext->GetEditContext())
        {
            editContext->Class<ScriptCanvas::Nodes::UnitTesting::ExpectTrue>("Expect True", "Expects a value to be true")
                ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->Attribute(AZ::Edit::Attributes::Icon, "Icons/ScriptCanvas/ExpectTrue.png")
...
bool ExpectTrueProperty::GetCandidate(ScriptCanvas::Node* owner)
{
...
AZStd::string ExpectTrueProperty::GetReport(ScriptCanvas::Node* owner)
{
