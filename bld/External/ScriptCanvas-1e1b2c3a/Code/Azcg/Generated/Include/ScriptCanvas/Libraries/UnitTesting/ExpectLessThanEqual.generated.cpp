...
#include "Include/ScriptCanvas/Libraries/UnitTesting/ExpectLessThanEqual.h"

void ScriptCanvas::Nodes::UnitTesting::ExpectLessThanEqual::ConfigureSlots()
{
...
bool ScriptCanvas::Nodes::UnitTesting::ExpectLessThanEqual::RequiresDynamicSlotOrdering() const
{
    return false;
}


bool ScriptCanvas::Nodes::UnitTesting::ExpectLessThanEqual::IsDeprecated() const
{
    return true;
}

ScriptCanvas::NodeConfiguration ScriptCanvas::Nodes::UnitTesting::ExpectLessThanEqual::GetReplacementNodeConfiguration() const
{
    ScriptCanvas::NodeConfiguration nodeConfig{};
    nodeConfig.m_type = AZ::Uuid("{C1E3C9D0-42E3-4D00-AE73-2A881E7E76A8}");
        nodeConfig.m_methodName = "Expect Less Than Equal";
            nodeConfig.m_className = "Unit Testing";
        return nodeConfig;
}

void ScriptCanvas::Nodes::UnitTesting::ExpectLessThanEqual::Reflect(AZ::ReflectContext* context)
{
    ...
    {
        serializeContext->Class<ScriptCanvas::Nodes::UnitTesting::ExpectLessThanEqual, ScriptCanvas::Node>()
            ->Version(1, &ScriptCanvas::UnitTesting::ExpectComparisonVersioner)
        ;

        if (AZ::EditContext* editContext = serializeContext->GetEditContext())
        {
            editContext->Class<ScriptCanvas::Nodes::UnitTesting::ExpectLessThanEqual>("Expect Less Than Equal", "Expects lhs to be greater than rhs")
                ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->Attribute(AZ::Edit::Attributes::Icon, "Icons/ScriptCanvas/ExpectLessThanEqual.png")
...
AZStd::string ExpectLessThanEqualProperty::GetReport(ScriptCanvas::Node* owner)
{
