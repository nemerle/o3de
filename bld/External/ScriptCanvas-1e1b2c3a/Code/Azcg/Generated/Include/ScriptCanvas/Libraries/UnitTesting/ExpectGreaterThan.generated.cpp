...
#include "Include/ScriptCanvas/Libraries/UnitTesting/ExpectGreaterThan.h"

void ScriptCanvas::Nodes::UnitTesting::ExpectGreaterThan::ConfigureSlots()
{
...
bool ScriptCanvas::Nodes::UnitTesting::ExpectGreaterThan::RequiresDynamicSlotOrdering() const
{
    return false;
}


bool ScriptCanvas::Nodes::UnitTesting::ExpectGreaterThan::IsDeprecated() const
{
    return true;
}

ScriptCanvas::NodeConfiguration ScriptCanvas::Nodes::UnitTesting::ExpectGreaterThan::GetReplacementNodeConfiguration() const
{
    ScriptCanvas::NodeConfiguration nodeConfig{};
    nodeConfig.m_type = AZ::Uuid("{C1E3C9D0-42E3-4D00-AE73-2A881E7E76A8}");
        nodeConfig.m_methodName = "Expect Greater Than";
            nodeConfig.m_className = "Unit Testing";
        return nodeConfig;
}

void ScriptCanvas::Nodes::UnitTesting::ExpectGreaterThan::Reflect(AZ::ReflectContext* context)
{
    ...
    {
        serializeContext->Class<ScriptCanvas::Nodes::UnitTesting::ExpectGreaterThan, ScriptCanvas::Node>()
            ->Version(1, &ScriptCanvas::UnitTesting::ExpectComparisonVersioner)
        ;

        if (AZ::EditContext* editContext = serializeContext->GetEditContext())
        {
            editContext->Class<ScriptCanvas::Nodes::UnitTesting::ExpectGreaterThan>("Expect Greater Than", "Expects lhs to be greater than rhs")
                ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->Attribute(AZ::Edit::Attributes::Icon, "Icons/ScriptCanvas/ExpectGreaterThan.png")
...
AZStd::string ExpectGreaterThanProperty::GetReport(ScriptCanvas::Node* owner)
{
