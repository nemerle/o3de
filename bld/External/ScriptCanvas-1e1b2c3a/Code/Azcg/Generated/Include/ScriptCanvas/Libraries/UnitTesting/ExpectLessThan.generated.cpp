 ...
 * Template Source /fast_drive/development/Hobby/Games/o3de/Gems/ScriptCanvas/Code/Include/ScriptCanvas/AutoGen/ScriptCanvasGrammar_Source.jinja; Data Sources /fast_drive/development/Hobby/Games/o3de/Gems/ScriptCanvas/Code/Include/ScriptCanvas/Libraries/UnitTesting/ExpectLessThan.ScriptCanvasGrammar.xml
 */
...
#include "Include/ScriptCanvas/Libraries/UnitTesting/ExpectLessThan.h"

void ScriptCanvas::Nodes::UnitTesting::ExpectLessThan::ConfigureSlots()
{
...
bool ScriptCanvas::Nodes::UnitTesting::ExpectLessThan::RequiresDynamicSlotOrdering() const
{
    return false;
}


bool ScriptCanvas::Nodes::UnitTesting::ExpectLessThan::IsDeprecated() const
{
    return true;
}

ScriptCanvas::NodeConfiguration ScriptCanvas::Nodes::UnitTesting::ExpectLessThan::GetReplacementNodeConfiguration() const
{
    ScriptCanvas::NodeConfiguration nodeConfig{};
    nodeConfig.m_type = AZ::Uuid("{C1E3C9D0-42E3-4D00-AE73-2A881E7E76A8}");
        nodeConfig.m_methodName = "Expect Less Than";
            nodeConfig.m_className = "Unit Testing";
        return nodeConfig;
}

void ScriptCanvas::Nodes::UnitTesting::ExpectLessThan::Reflect(AZ::ReflectContext* context)
{
    ...
    {
        serializeContext->Class<ScriptCanvas::Nodes::UnitTesting::ExpectLessThan, ScriptCanvas::Node>()
            ->Version(1, &ScriptCanvas::UnitTesting::ExpectComparisonVersioner)
        ;

        if (AZ::EditContext* editContext = serializeContext->GetEditContext())
        {
            editContext->Class<ScriptCanvas::Nodes::UnitTesting::ExpectLessThan>("Expect Less Than", "Expects lhs to be less than rhs")
                ->ClassElement(AZ::Edit::ClassElements::EditorData, "")
                    ->Attribute(AZ::Edit::Attributes::Visibility, AZ::Edit::PropertyVisibility::ShowChildrenOnly)
                    ->Attribute(AZ::Edit::Attributes::AutoExpand, true)
                    ->Attribute(AZ::Edit::Attributes::Icon, "Icons/ScriptCanvas/ExpectLessThan.png")
...
AZStd::string ExpectLessThanProperty::GetReport(ScriptCanvas::Node* owner)
{
