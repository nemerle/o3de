...
#include <memory>
#include "../../../../../../Gems/LyShine/Code/Editor/ModeToolbar.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ModeToolbar_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject ModeToolbar::staticMetaObject = { {
    QMetaObject::SuperData::link<QToolBar::staticMetaObject>(),
    qt_meta_stringdata_ModeToolbar.data,
    qt_meta_data_ModeToolbar,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ModeToolbar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ModeToolbar.stringdata0))
