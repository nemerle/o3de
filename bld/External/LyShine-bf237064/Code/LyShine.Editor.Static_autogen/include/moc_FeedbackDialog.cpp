...
#include <memory>
#include "../../../../../../Gems/LyShine/Code/Editor/FeedbackDialog.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FeedbackDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FeedbackDialog_t qt_meta_stringdata_FeedbackDialog = {
    {
QT_MOC_LITERAL(0, 0, 14) // "FeedbackDialog"
...
QT_INIT_METAOBJECT const QMetaObject FeedbackDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_FeedbackDialog.data,
    qt_meta_data_FeedbackDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *FeedbackDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FeedbackDialog.stringdata0))
