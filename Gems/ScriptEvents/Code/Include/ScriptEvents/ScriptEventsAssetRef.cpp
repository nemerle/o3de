...
namespace ScriptEvents
{
    ...
    const ScriptEvent *ScriptEventsAssetRef::GetDefinition() const
    {
    ...
    void ScriptEventsAssetRef::Load(bool loadBlocking)
    {
        if (!m_asset.IsReady())
        {
    ...
    void ScriptEventsAssetRef::OnAssetUnloaded([[maybe_unused]] const AZ::Data::AssetId assetId, [[maybe_unused]] const AZ::Data::AssetType assetType)
    {
        if (ScriptEventsAsset* ebusAsset = m_asset.GetAs<ScriptEventsAsset>())
        {
