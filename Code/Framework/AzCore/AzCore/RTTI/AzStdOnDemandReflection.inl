...
namespace AZ
{
    ...
    struct OnDemandReflection< AZStd::basic_string<Element, Traits, Allocator> >
    {
        ...
        static void Reflect(ReflectContext* context)
        {
            ...
            static_assert (is_string, "Unspecialized basic_string<> template reflection demanded.");
        }
    };
    ...
    struct OnDemandReflection< AZStd::basic_string_view<Element, Traits> >
    {
        ...
        static void Reflect(ReflectContext* context)
        {
            ...
            static_assert (is_common, "Unspecialized basic_string_view<> template reflection demanded.");
