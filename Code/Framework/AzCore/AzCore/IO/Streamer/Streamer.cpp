...
namespace AZ::IO
{
        ...
        IStreamerTypes::ClaimMemory claimMemory) const
    {
        ...
        auto readRequest = AZStd::get_if<RequestCommands::ReadRequestData>(&request.m_request->GetCommand());
    ...
    FileRequestPtr Streamer::Report(FileRequestReportType reportType)
    {
        FileRequestPtr result = CreateRequest();
    ...
    FileRequestPtr& Streamer::Report(FileRequestPtr& request, FileRequestReportType reportType)
    {
