...
namespace AZ::IO
{
    ...
    namespace RequestCommands
    {
        ...
        struct ReportData
        {
            ...
            using ReportType = FileRequestReportType;
    ...
    public:
        ...
        using CommandVariant = AZStd::variant<AZStd::monostate, ExternalRequestData, RequestPathStoreData, RequestCommands::ReadRequestData, RequestCommands::ReadData,
            CompressedReadData, WaitData, FileExistsCheckData, FileMetaDataRetrievalData, CancelData, RescheduleData, FlushData,
            FlushAllData, RequestCommands::CreateDedicatedCacheData, RequestCommands::DestroyDedicatedCacheData, RequestCommands::ReportData, CustomData>;
        ...
        void CreateReport(FileRequestReportType reportType);
