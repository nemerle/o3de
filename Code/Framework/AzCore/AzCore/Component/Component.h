...
#define AZ_COMPONENT_BASE(_ComponentClass, ...)                                                                                            \
    ...
    {                                                                                                                                      \
        ...
        AZ::ComponentDescriptorBus::Event(                                                                                                 \
            _ComponentClass::RTTI_Type(),                                                                                                  \
            [&](AZ::ComponentDescriptor* interface)                                                                                        \
            {                                                                                                                              \
                descriptor = interface->GetDescriptor();                                                                                   \
            });                                                                                                                            \
        if (descriptor)                                                                                                                    \
        {                                                                                                                                  \
            ...
            {                                                                                                                              \
                AZ_Error(                                                                                                                  \
                    "Component", false,                                                                                                    \
                    "Two different components have the same UUID (%s), which is not allowed.\n"                                            \
            ...
            {                                                                                                                              \
                AZ_Error(                                                                                                                  \
                    "Component", false,                                                                                                    \
                    "The same component UUID (%s) / name (%s) was registered twice.  This isn't allowed, "                                 \
