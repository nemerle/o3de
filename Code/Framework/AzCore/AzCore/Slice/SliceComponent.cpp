...
namespace AZ
{
    namespace Converters
    {
        ...
        bool SliceReferenceVersionConverter(SerializeContext& context, Serialization::DataElementNode& classElement)
        {
            if (classElement.GetVersion() < 2)
            {
                ...
                if (instancesIndex > -1)
                {
                    ...
                    AZStd::vector<Serialization::DataElementNode> subElements;
                    ...
                    {
                        for (const Serialization::DataElementNode& subElement : subElements)
                        {
